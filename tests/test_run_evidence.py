...
def test_run_evidence_reads_trace_report_and_session_artifacts(tmp_path):
    workspace = tmp_path
    run_dir = workspace / ".deepcode" / "runs" / "run_1"
    session_dir = workspace / ".deepcode" / "sessions"
        ...
        json.dumps(
            {
                ...
                "runtime_reminders": [{"artifact_path": ".deepcode/runs/run_1/artifacts/fallback.txt"}],
                ...
                json.dumps(
                    {
                        "event": "tool_executed",
                        "name": "run_shell",
                        "full_output_artifact": ".deepcode/runs/run_1/artifacts/output.txt",
                    }
                ),
    ...
    assert evidence.full_output_artifacts() == [
        ".deepcode/runs/run_1/artifacts/output.txt",
        ".deepcode/runs/run_1/artifacts/fallback.txt",
    ]
