...
from deepcode.core.run_store import RunStore
from deepcode.core.task_state import STOP_REASON_FINAL_ANSWER_RETURNED, TaskState


def test_run_store_creates_run_directory_and_state_file(tmp_path):
    store = RunStore(tmp_path / ".deepcode" / "runs")
