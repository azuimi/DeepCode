...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available DeepCode skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a DeepCode skill."),
    ...
    SlashCommand("exit", "/exit", "Exit DeepCode.", ("quit",)),
)
