...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "deepcode" / "config.toml"
PROJECT_CONFIG_NAME = ".deepcode.toml"
...
ENV_PROVIDER = "DEEPCODE_PROVIDER"
ENV_API_KEY = "DEEPCODE_API_KEY"
ENV_BASE_URL = "DEEPCODE_BASE_URL"
ENV_MODEL = "DEEPCODE_MODEL"
...
LEGACY_ENV_NAMES = {
    "openai": {
        "api_key": ("DEEPCODE_OPENAI_API_KEY", "OPENAI_API_KEY"),
        "base_url": ("DEEPCODE_OPENAI_API_BASE", "OPENAI_API_BASE", "OPENAI_BASE_URL"),
        "model": ("DEEPCODE_OPENAI_MODEL", "OPENAI_MODEL"),
    },
    "anthropic": {
        "api_key": (
            "DEEPCODE_ANTHROPIC_API_KEY",
            "ANTHROPIC_API_KEY",
            "DEEPCODE_RIGHT_CODES_API_KEY",
            "RIGHT_CODES_API_KEY",
            "DEEPCODE_OPENAI_API_KEY",
            "OPENAI_API_KEY",
        ),
        "base_url": (
            "DEEPCODE_ANTHROPIC_API_BASE",
            "ANTHROPIC_API_BASE",
            "ANTHROPIC_BASE_URL",
        ),
        "model": ("DEEPCODE_ANTHROPIC_MODEL", "ANTHROPIC_MODEL"),
    },
    "deepseek": {
        "api_key": ("DEEPCODE_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        "base_url": (
            "DEEPCODE_DEEPSEEK_API_BASE",
            "DEEPSEEK_API_BASE",
            "DEEPSEEK_BASE_URL",
        ),
        "model": ("DEEPCODE_DEEPSEEK_MODEL", "DEEPSEEK_MODEL"),
    },
}
...
def resolve_provider_config(
    ...
    *,
    ...
    protocol = _first_value(
        None,
        os.environ.get("DEEPCODE_PROTOCOL"),
        profile_values.get("protocol"),
        legacy_env.get("DEEPCODE_PROTOCOL"),
...
def _read_config_file(path: Path) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f"invalid DeepCode config file {path}: {exc}") from exc
    except OSError as exc:
        raise ValueError(f"could not read DeepCode config file {path}: {exc}") from exc
