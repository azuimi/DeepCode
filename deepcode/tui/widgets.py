...
class AssistantMessage(Static):
    ...
    def compose(self):
        yield Static("deepcode", classes="message-label")
...
class InputBar(Static):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.input = Input(placeholder="Ask deepcode or type /help")
    ...
    def set_busy(self, busy: bool) -> None:
        ...
        self.input.placeholder = (
            "deepcode is working..." if busy else "Ask deepcode or type /help"
        )
