...
SKILL_FILE_CREATION_GUIDE = """When creating DeepCode skill files at .deepcode/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${DEEPCODE_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".deepcode" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".deepcode" / "skills", "project"),
    ]
