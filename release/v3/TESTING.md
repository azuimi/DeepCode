...
It drives DeepCode through CLI, REPL, slash command, resume, provider profile,
skills, worker, memory, and artifact flows, then verifies the files DeepCode wrote.
